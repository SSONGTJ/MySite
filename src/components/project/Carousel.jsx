                    ...
                    <div className="swiper-slide">
                        <div className="swiper-carousel-animate-opacity">
                            ...
                            <div className="slide-content">
                                <h2>Todo List</h2>
                                <p>
                                    Next.js, FireBase 활용하여 DB를 구현한 todo
                                    list
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="swiper-slide">
                        <div className="swiper-carousel-animate-opacity">
                            ...
                            <div className="slide-content">
                                ...
                                <p>
                                    America Chavez and a version of Stephen
                                    Strange are chased by a demon in the space
                                    between universes while searching for the
                                    Book of Vishanti.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="swiper-slide">
                        <div className="swiper-carousel-animate-opacity">
                            ...
                            <div className="slide-content">
                                <h2>Eternals</h2>
                                <p>
                                    In 5000 BC, ten superpowered Eternals—Ajak,
                                    Sersi, Ikaris, Kingo, Sprite, Phastos,
                                    Makkari, Druig, Gilgamesh, and Thena—are
                                    sent by the Celestial Arishem to Earth on
                                    their starship, the Domo, to exterminate the
                                    invasive Deviants.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="swiper-slide">
                        <div className="swiper-carousel-animate-opacity">
                            ...
                            <div className="slide-content">
                                ...
                                <p>
                                    Determined to ensure Superman's ultimate
                                    sacrifice was not in vain, Bruce Wayne
                                    aligns forces with Diana Prince with plans
                                    to recruit a team of metahumans to protect
                                    the world from an approaching threat of
                        ...
                        <div className="swiper-carousel-animate-opacity">
                            ...
                            <div className="slide-content">
                                ...
                                <p>
                                    ...
                                    (2019), Spider-Man must step up to take on
                        ...
                        <div className="swiper-carousel-animate-opacity">
                            ...
                            <div className="slide-content">
                                ...
                                <p>
                                    ...
                                    Peacemaker and a collection of nutty cons at
                                    Belle Reve prison join the super-secret,
                                    super-shady Task Force X as they are dropped
                                    off at the remote, enemy-infused island of
                                    Corto Maltese.
                                </p>
                            </div>
                        </div>
